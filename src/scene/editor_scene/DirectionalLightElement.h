...
namespace EditorScene {
    ...
    public:
        ...
        // Position is only used for the in-world visual marker.
        glm::vec3 position;

        // Local direction the light travels.
        glm::vec3 direction;
        ...
        std::shared_ptr<EmissiveEntityRenderer::Entity> light_visual;
        ...
        DirectionalLightElement(
            ...
            light_visual(std::move(light_visual)) {}
